...
def build_module_kwargs() -> dict:
    ...
    return dict(
        checkpoint_path=None  # TODO: pick a value for 'checkpoint_path',
        kmeans_path=None  # TODO: pick a value for 'kmeans_path',
    )


def build_forward_inputs() -> tuple[tuple, dict]:
    """Return (positional args, keyword args) for the forward call."""
    wav_input = torch.randn(BATCH, SEQ_LEN, HIDDEN)  # TODO: shape for 'wav_input'
    return (wav_input,), {}
