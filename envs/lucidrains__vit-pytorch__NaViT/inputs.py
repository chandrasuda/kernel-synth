...
def build_module_kwargs() -> dict:
    ...
    return dict(
        image_size=32,
        max_frames=None  # TODO: pick a value for 'max_frames',
        patch_size=4,
        frame_patch_size=None  # TODO: pick a value for 'frame_patch_size',
        num_classes=10,
        dim=64,
        depth=2,
        heads=4,
...
def build_forward_inputs() -> tuple[tuple, dict]:
    ...
    volumes = torch.randn(BATCH, SEQ_LEN, HIDDEN)  # TODO: shape for 'volumes'
    return (volumes,), {}
