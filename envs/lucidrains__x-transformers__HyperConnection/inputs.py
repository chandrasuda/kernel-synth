...
def build_module_kwargs() -> dict:
    ...
    return dict(
        dim=64,
        layer_index=None  # TODO: pick a value for 'layer_index',
        num_residual_streams=None  # TODO: pick a value for 'num_residual_streams',
    )
...
def build_forward_inputs() -> tuple[tuple, dict]:
    ...
    residuals = torch.randn(BATCH, SEQ_LEN, HIDDEN)  # TODO: shape for 'residuals'
    beta = torch.randn(BATCH, SEQ_LEN, HIDDEN)  # TODO: shape for 'beta'
    return (x, residuals, beta,), {}
