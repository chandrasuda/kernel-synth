...
def build_module_kwargs() -> dict:
    ...
    return dict(
        wav2vec=None  # TODO: pick a value for 'wav2vec',
        codec=None  # TODO: pick a value for 'codec',
        semantic_transformer=None  # TODO: pick a value for 'semantic_transformer',
        coarse_transformer=None  # TODO: pick a value for 'coarse_transformer',
        fine_transformer=None  # TODO: pick a value for 'fine_transformer',
    )
