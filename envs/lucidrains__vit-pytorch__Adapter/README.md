# `Adapter`  ·  RL kernel-engineering env

> file imports einops, einops, einops, einops, einops; non-trivial parameter init

**Source:** [`lucidrains/vit-pytorch`](https://github.com/lucidrains/vit-pytorch) · `vit_pytorch/learnable_memory_vit.py`
(lines 157–218)
**Novelty:** 0.85
...
Write an implementation of `Adapter` in `solution.py` that is
...
```python
Adapter.__init__(vit, num_memories_per_layer=10, num_classes=2)
Adapter.forward(img)
```
