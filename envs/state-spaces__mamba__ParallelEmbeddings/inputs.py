...
def build_module_kwargs() -> dict:
    ...
    return dict(
        embed_dim=64,
        vocab_size=1024,
        max_position_embeddings=None  # TODO: pick a value for 'max_position_embeddings',
        process_group=None  # TODO: pick a value for 'process_group',
    )


def build_forward_inputs() -> tuple[tuple, dict]:
    """Return (positional args, keyword args) for the forward call."""
    input_ids = torch.randint(0, 1024, (BATCH, SEQ_LEN))
    return (input_ids,), {}
