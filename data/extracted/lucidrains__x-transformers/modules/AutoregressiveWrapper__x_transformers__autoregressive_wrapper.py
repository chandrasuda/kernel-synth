...
# Source: x_transformers/autoregressive_wrapper.py (lines 158-687)
# Class: AutoregressiveWrapper
# Tags: cumsum, imports:einops, math-heavy, scatter, topk
# Novelty: 0.89
# Reason: forward uses cumsum, scatter, topk; ~12 arithmetic ops in forward; file imports einops, einops, einops, einops, einops
