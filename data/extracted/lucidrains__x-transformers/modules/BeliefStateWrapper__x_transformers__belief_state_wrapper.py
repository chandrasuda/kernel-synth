...
# Source: x_transformers/belief_state_wrapper.py (lines 79-432)
# Class: BeliefStateWrapper
# Tags: imports:einops, math-heavy, self-contained, uses-buffers
# Novelty: 0.90
# Reason: ~13 arithmetic ops in forward; file imports einops, einops, einops, einops, einops, einops, einops
