...
# Class: CoarseTransformer
# Tags: custom-init, einsum, imports:einops, looks-generic, math-heavy, self-contained
# Novelty: 0.78
# Reason: forward uses einsum; ~10 arithmetic ops in forward; file imports einops, einops, einops, einops, einops, einops; non-trivial parameter init
