...
# Source: vit_pytorch/na_vit.py (lines 195-402)
# Class: NaViT
# Tags: custom-init, imports:einops, math-heavy, self-contained, topk
# Novelty: 0.98
# Reason: forward uses topk; ~10 arithmetic ops in forward; file imports einops, einops, einops; non-trivial parameter init
